# -*- coding: utf-8 -*-
"""
Created on Wed Nov 15 18:34:27 2023
...
btnAdd=Button(btn_frame,command=add_employee,text='Add Details',width=15,font=('Calibri',16,'bold'),fg='white',bg='#16a005',bd=0).grid(row=0,column=0,padx=10)

btnEdit=Button(btn_frame,command=update_employee,text='Update Details',width=15,font=('Calibri',16,'bold'),fg='white',bg='blue',bd=0).grid(row=0,column=1,padx=10)

btnDelete=Button(btn_frame,command=delete_employee,text='Delete Details',width=15,font=('Calibri',16,'bold'),fg='white',bg='red',bd=0).grid(row=0,column=2,padx=10)

btnClear=Button(btn_frame,command=clearAll,text='Clear Details',width=15,font=('Calibri',16,'bold'),fg='white',bg='orange',bd=0).grid(row=0,column=3,padx=10)
# Table frame

tree_frame=Frame(root,bg='white')
tree_frame.place(x=0,y=480,width=1370,height=520)

style=ttk.Style()
style.configure('mystyle.Treeview', font=('Calibri',10),rowheight=50)
